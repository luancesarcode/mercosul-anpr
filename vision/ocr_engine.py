...
from vision.ocr.aplicar_ocr import aplicar_ocr
from vision.ocr.utils import PADDLE_LANGS, carregar_paddle
from vision.ocr_rules import escolher_texto_ocr
...
class OCREngine:
    ...
    def read_candidate(self, candidate: dict[str, Any]) -> OCRResult:
        ...
        text, score, pattern = escolher_texto_ocr(ocr_result)
