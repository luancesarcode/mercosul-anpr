...
def _build_detection_config() -> DetectionConfig:
    return DetectionConfig(
        img_size=_env_int("ANPR_IMG_SIZE", constants.DEFAULT_IMG_SIZE),
        vehicle_conf=_env_float("ANPR_VEHICLE_CONF", constants.DEFAULT_VEHICLE_CONF),
        vehicle_iou=_env_float("ANPR_VEHICLE_IOU", constants.DEFAULT_VEHICLE_IOU),
        vehicle_min_area_ratio=_env_float(
            "ANPR_VEHICLE_MIN_AREA_RATIO",
            constants.DEFAULT_VEHICLE_MIN_AREA_RATIO,
        ),
        plate_conf=_env_float("ANPR_PLATE_CONF", constants.DEFAULT_PLATE_CONF),
        plate_recall_conf=_env_float(
            "ANPR_PLATE_RECALL_CONF",
            constants.DEFAULT_PLATE_RECALL_CONF,
        ),
        plate_iou=_env_float("ANPR_PLATE_IOU", constants.DEFAULT_PLATE_IOU),
...
def _build_tracking_config() -> TrackingConfig:
    return TrackingConfig(
        track_iou=_env_float("ANPR_TRACK_IOU", constants.DEFAULT_TRACK_IOU),
        ...
        plate_min_score=_env_float("ANPR_PLATE_MIN_SCORE", constants.DEFAULT_PLATE_MIN_SCORE),
...
def _build_association_config() -> AssociationConfig:
    return AssociationConfig(
        ...
        association_threshold=_env_float(
            "ANPR_ASSOCIATION_THRESHOLD",
            constants.DEFAULT_ASSOCIATION_THRESHOLD,
        ),
        association_weights=(
            _env_float("ANPR_ASSOC_WEIGHT_IOU", constants.DEFAULT_ASSOCIATION_WEIGHTS[0]),
            _env_float("ANPR_ASSOC_WEIGHT_CENTER", constants.DEFAULT_ASSOCIATION_WEIGHTS[1]),
            _env_float("ANPR_ASSOC_WEIGHT_SIZE", constants.DEFAULT_ASSOCIATION_WEIGHTS[2]),
        ),
...
def _build_display_config() -> DisplayConfig:
    conf_min = _env_float("ANPR_PLATE_TEXT_CONF_MIN", constants.DEFAULT_PLATE_TEXT_CONF_MIN)
    conf_max = _env_float("ANPR_PLATE_TEXT_CONF_MAX", constants.DEFAULT_PLATE_TEXT_CONF_MAX)
